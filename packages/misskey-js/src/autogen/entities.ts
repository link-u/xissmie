...
export type AdminAccountsGetLoginTokenRequest = operations['admin___accounts___get-login-token']['requestBody']['content']['application/json'];
export type AdminAccountsGetLoginTokenResponse = operations['admin___accounts___get-login-token']['responses']['200']['content']['application/json'];
...
export type LoginWithTokenRequest = operations['login-with-token']['requestBody']['content']['application/json'];
